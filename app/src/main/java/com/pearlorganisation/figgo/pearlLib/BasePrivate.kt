package com.pearlorganisation.figgo.pearlLib
...
import com.pearlorganisation.figgo.UI.OneWay_Km_CountActivity
...
abstract class BasePrivate : BaseClass() {
    ...
    fun CheckSession(baseApbcContext: Context?, activityIn: AppCompatActivity) {
        ...
        if (!session_available) {
            val intent1 = Intent(baseApbcContext, OneWay_Km_CountActivity::class.java)
